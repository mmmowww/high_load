...
$SCC = " 
    ...
    <link rel='stylesheet' href='views/cargo/fonts/icomoon/style.css'>
    <link rel='stylesheet' href='views/cargo/bootstrap.min.css'>
    <link rel='stylesheet' href='views/cargocss/jquery.fancybox.min.css'>
    <link rel='stylesheet' href='views/cargo/css/owl.carousel.min.css'>
    <link rel='stylesheet' href='views/cargo/css/owl.theme.default.min.css'>
    <link rel='stylesheet' href='views/cargo/fonts/flaticon/font/flaticon.css'>
    <link rel='stylesheet' href='views/cargo/css/aos.css'>
    <link rel='stylesheet' href='views/cargo/css/style.css'>";
$Site = "
  ...
  <body data-spy='scroll' data-target='.site-navbar-target' data-offset='300'>
          ...
          <div class='container'>
            <div class='owl-carousel owl-all'>
              <div class='service text-center'>
                <a href='#'><img src='views/cargo/images/cargo_sea_small.jpg' alt='Image' class='img-fluid'></a>
                <div class='px-md-3'>
              ...
              <div class='service text-center'>
                <a href='#'><img src='views/cargo/images/cargo_air_small.jpg' alt='Image' class='img-fluid'></a>
                <div class='px-md-3'>
              ...
              <div class='service text-center'>
                <a href='#'><img src='views/cargo/images/cargo_delivery_small.jpg' alt='Image' class='img-fluid'></a>
                <div class='px-md-3'>
          ...
          <div class='row justify-content-center mb-4 block-img-video-1-wrap'>
            <div class='col-md-12 mb-5'>
              <figure class='block-img-video-1' data-aos='fade'>
                ...
                <img src='views/cargo/images/cargo_delivery_big.jpg' alt='Image' class='img-fluid'>
              </a>
              </figure>
            </div>
          </div>
        ...
        <div class='container'>
          ...
          <div class='owl-carousel owl-all'>
            <div class='block-team-member-1 text-center rounded h-100'>
              <figure>
                <img src='views/cargo/images/person_1.jpg' alt='Image' class='img-fluid rounded-circle'>
              </figure>
            ...
            <div class='block-team-member-1 text-center rounded h-100'>
              <figure>
                <img src='views/cargo/images/person_2.jpg' alt='Image' class='img-fluid rounded-circle'>
              </figure>
            ...
            <div class='block-team-member-1 text-center rounded h-100'>
              <figure>
                <img src='views/cargo/images/person_3.jpg' alt='Image' class='img-fluid rounded-circle'>
              </figure>
          ...
          <div class='owl-carousel nonloop-block-13'>
            <div>
              <div class='block-testimony-1 text-center'>
                ...
                <figure>
                  <img src='views/cargo/images/person_4.jpg' alt='Image' class='img-fluid rounded-circle mx-auto'>
                </figure>
            ...
            <div>
              <div class='block-testimony-1 text-center'>
                ...
                <figure>
                  <img src='views/cargo/images/person_2.jpg' alt='Image' class='img-fluid rounded-circle mx-auto'>
                </figure>
            ...
            <div>
              <div class='block-testimony-1 text-center'>
                ...
                <figure>
                  <img src='views/cargo/images/person_1.jpg' alt='Image' class='img-fluid rounded-circle mx-auto'>
                </figure>
            ...
            <div>
              <div class='block-testimony-1 text-center'>
                ...
                <figure>
                  <img src='views/cargo/images/person_3.jpg' alt='Image' class='img-fluid rounded-circle mx-auto'>
                </figure>
          ...
          <div class='row'>
            <div class='col-lg-6'>
              <div class='mb-5 d-flex blog-entry' data-aos='fade-right' data-aos-delay=''>
                <a href='#' class='blog-thumbnail'><img src='views/cargo/images/cargo_sea_small.jpg' alt='Image' class='img-fluid'></a>
                <div class='blog-excerpt'>
                  ...
                  <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts</p>
                  <p><a href='views/cargo/single.html' class='text-primary'>Read More</a></p>
                </div>
              </div>
            </div>
            <div class='col-lg-6'>
              <div class='mb-5 d-flex blog-entry' data-aos='fade-right' data-aos-delay=''>
                <a href='#' class='blog-thumbnail'><img src='views/cargo/images/cargo_air_small.jpg' alt='Image' class='img-fluid'></a>
                <div class='blog-excerpt'>
                  <span class='d-block text-muted'>Apr 19, 2019</span>
                  <h2 class='h4  mb-3'><a href='views/cargo/single.html'>Knowing the Difference Is Key to Effective Logistics</a></h2>
    ...
    <script src='views/cargo/js/jquery-3.3.1.min.js'></script>
    <script src='views/cargo/js/popper.min.js'></script>
    <script src='views/cargo/js/bootstrap.min.js'></script>
    <script src='views/cargo/js/owl.carousel.min.js'></script>
    <script src='views/cargo/js/jquery.sticky.js'></script>
    <script src='views/cargo/js/jquery.waypoints.min.js'></script>
    <script src='views/cargo/js/jquery.animateNumber.min.js'></script>
    <script src='views/cargo/js/jquery.fancybox.min.js'></script>
    <script src='views/cargo/js/jquery.easing.1.3.js'></script>
    <script src='views/cargo/js/aos.js'></script>

    <script src='views/cargo/js/main.js'></script>
